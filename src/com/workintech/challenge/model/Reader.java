...
import com.workintech.challenge.util.EnumTypes;
...
public class Reader extends User {
    ...
    // Constructor
    public Reader(int id, String name, String email, String username, String password, String role, int memberRecordId, EnumTypes.UserRole userRole) {
        super(id, name, email, username, password, role, memberRecordId);
        this.borrowedBooks = new ArrayList<>();
    }

    public Reader(int id, String name, String email, EnumTypes.UserRole userRole) {
        super(id,
                name,
                email,
                userRole);
    ...
    public String whoYouAre() {
        int bookCount = (borrowedBooks != null) ? borrowedBooks.size() : 0;
        return String.format("Reader %s, email %s with %d borrowed books", getName(), getEmail(), bookCount);
    }
}